...
TEST_CASE("g constant accelerations/potentials")
{
    tuple_for_each(macs{}, [](auto mac_type) {
        tuple_for_each(fp_types{}, [](auto x) {
            ...
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[0].begin(), accs_pots_u_orig[0].begin())),
            ...
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[1].begin(), accs_pots_u_orig[1].begin())),
                boost::make_zip_iterator(boost::make_tuple(accpots[1].end(), accs_pots_u_orig[1].end())),
                [](auto t) { return boost::get<0>(t) == fp_type(2) * boost::get<1>(t); }));
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[2].begin(), accs_pots_u_orig[2].begin())),
                boost::make_zip_iterator(boost::make_tuple(accpots[2].end(), accs_pots_u_orig[2].end())),
                [](auto t) { return boost::get<0>(t) == fp_type(2) * boost::get<1>(t); }));
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[3].begin(), accs_pots_u_orig[3].begin())),
            ...
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[0].begin(), accs_pots_o_orig[0].begin())),
            ...
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[1].begin(), accs_pots_o_orig[1].begin())),
                boost::make_zip_iterator(boost::make_tuple(accpots[1].end(), accs_pots_o_orig[1].end())),
                [](auto t) { return boost::get<0>(t) == boost::get<1>(t) / fp_type(2); }));
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[2].begin(), accs_pots_o_orig[2].begin())),
                boost::make_zip_iterator(boost::make_tuple(accpots[2].end(), accs_pots_o_orig[2].end())),
                [](auto t) { return boost::get<0>(t) == boost::get<1>(t) / fp_type(2); }));
            REQUIRE(std::all_of(
                boost::make_zip_iterator(boost::make_tuple(accpots[3].begin(), accs_pots_o_orig[3].begin())),
